...
def memory_buffer_qa_component(prompt):
	...
	prompt_template = st.session_state.prompt_template + f"""
						You are a person who survived an episode of heart attack. Answer questions in conversational Singaporean style in less than 100 words to help 13 and 14 years old students 
