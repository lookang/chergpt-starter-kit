	...
	if st.session_state.option == 'Users login':
			...
			with placeholder2:
				...
				with col2:
					...
					st.write("2. Teacher's account: tch1 to tch10, email weelookang@gmail.com for the password")
					st.write("3. Student's account: stu1 to stu 40 password is default_password")
